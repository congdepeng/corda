...
class BFTNonValidatingNotaryService(override val services: ServiceHubInternal) : NotaryService() {
    ...
    override fun createServiceFlow(otherParty: Party): ServiceFlow {
        return ServiceFlow(otherParty, this)
    }

    class ServiceFlow(val otherSide: Party, val service: BFTNonValidatingNotaryService) : FlowLogic<Void?>() {
        @Suspendable
